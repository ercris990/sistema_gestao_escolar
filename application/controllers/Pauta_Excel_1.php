...
class Pauta_Excel_1 extends CI_Controller 
{
    ...
    $this->db->where("turma_id", $turma);									 																		// onde
		...
		foreach($dados['ed_plastica'] as $ed_plstic){
			...
			/*-------------------------------------------- FORMULA ---------------------------------------------------------------------------*/	
			$objPHPExcel->getActiveSheet()->setCellValue('W'.$row, '=IF(AND(G'.$row.'>=5, J'.$row.'>=5, M'.$row.'>=5, P'.$row.'>=5, S'.$row.'>=5, V'.$row.'>=5), "Aprovado", IF(AND(G'.$row.'>=5, J'.$row.'>=5, M'.$row.'<5, P'.$row.'<5, S'.$row.'>=5, V'.$row.'>=5), "Aprovado", IF(AND(G'.$row.'>=5, J'.$row.'>=5, M'.$row.'<5, P'.$row.'>=5, S'.$row.'<5, V'.$row.'>=5), "Aprovado", IF(AND(G'.$row.'>=5, J'.$row.'>=5, M'.$row.'<5, P'.$row.'>=5, S'.$row.'>=5, V'.$row.'<5), "Aprovado", IF(AND(G'.$row.'>=5, J'.$row.'>=5, M'.$row.'>=5, P'.$row.'<5, S'.$row.'<5, V'.$row.'>=5), "Aprovado", IF(AND(G'.$row.'>=5, J'.$row.'>=5, M'.$row.'>=5, P'.$row.'<5, S'.$row.'>=5, V'.$row.'<5), "Aprovado", IF(AND(G'.$row.'>=5, J'.$row.'>=5, M'.$row.'>=5, P'.$row.'>=5, S'.$row.'<5, V'.$row.'<5), "Aprovado", IF(AND(G'.$row.'>=5, J'.$row.'>=5, M'.$row.'<5, P'.$row.'>=5, S'.$row.'>=5, V'.$row.'>=5), "Aprovado", IF(AND(G'.$row.'>=5, J'.$row.'>=5, M'.$row.'>=5, P'.$row.'<5, S'.$row.'>=5, V'.$row.'>=5), "Aprovado", IF(AND(G'.$row.'>=5, J'.$row.'>=5, M'.$row.'>=5, P'.$row.'>=5, S'.$row.'<5, V'.$row.'>=5), "Aprovado", IF(AND(G'.$row.'>=5, J'.$row.'>=5, M'.$row.'>=5, P'.$row.'>=5, S'.$row.'>=5, V'.$row.'<5), "Aprovado", "Reprovado" )))))))))))');
			/*-----------------------------------------------------------------------------------------------------------------------------------*/
			$i++;
			$row++;
		}
