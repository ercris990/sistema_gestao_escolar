...
class Pauta_Excel_5 extends CI_Controller 
{
	public function exportar_pauta_5($anolectivo, $turma)
	{
		...
		foreach($dados['ed_musical'] as $ed_music){
			...
			/*-------------------------------------------- FORMULA ---------------------------------------------------------------------------*/	
			$objPHPExcel->getActiveSheet()->setCellValue('AO'.$row, '=IF(AND(G'.$row.'>=5, K'.$row.'>=5, O'.$row.'>=5, S'.$row.'>=5, W'.$row.'>=5, AA'.$row.'>=5, AE'.$row.'>=5, AI'.$row.'>=5, AM'.$row.'>=5 ), "Aprovado",IF(AND(G'.$row.'>=5, K'.$row.'>=5, O'.$row.'<5, S'.$row.'<5, W'.$row.'>=5, AA'.$row.'>=5, AE'.$row.'>=5, AI'.$row.'>=5, AM'.$row.'>=5 ), "Aprovado",IF(AND(G'.$row.'>=5, K'.$row.'>=5, O'.$row.'<5, S'.$row.'>=5, W'.$row.'<5, AA'.$row.'>=5, AE'.$row.'>=5, AI'.$row.'>=5, AM'.$row.'>=5 ), "Aprovado",IF(AND(G'.$row.'>=5, K'.$row.'>=5, O'.$row.'<5, S'.$row.'>=5, W'.$row.'>=5, AA'.$row.'<5, AE'.$row.'>=5, AI'.$row.'>=5, AM'.$row.'>=5 ), "Aprovado",IF(AND(G'.$row.'>=5, K'.$row.'>=5, O'.$row.'<5, S'.$row.'>=5, W'.$row.'>=5, AA'.$row.'>=5, AE'.$row.'<5, AI'.$row.'>=5, AM'.$row.'>=5 ), "Aprovado",IF(AND(G'.$row.'>=5, K'.$row.'>=5, O'.$row.'<5, S'.$row.'>=5, W'.$row.'>=5, AA'.$row.'>=5, AE'.$row.'>=5, AI'.$row.'<5, AM'.$row.'>=5 ), "Aprovado",IF(AND(G'.$row.'>=5, K'.$row.'>=5, O'.$row.'<5, S'.$row.'>=5, W'.$row.'>=5, AA'.$row.'>=5, AE'.$row.'>=5, AI'.$row.'>=5, AM'.$row.'<5 ), "Aprovado",IF(AND(G'.$row.'>=5, K'.$row.'>=5, O'.$row.'>=5, S'.$row.'<5, W'.$row.'<5, AA'.$row.'>=5, AE'.$row.'>=5, AI'.$row.'>=5, AM'.$row.'>=5 ), "Aprovado",IF(AND(G'.$row.'>=5, K'.$row.'>=5, O'.$row.'>=5, S'.$row.'<5, W'.$row.'>=5, AA'.$row.'<5, AE'.$row.'>=5, AI'.$row.'>=5, AM'.$row.'>=5 ), "Aprovado",IF(AND(G'.$row.'>=5, K'.$row.'>=5, O'.$row.'>=5, S'.$row.'<5, W'.$row.'>=5, AA'.$row.'>=5, AE'.$row.'<5, AI'.$row.'>=5, AM'.$row.'>=5 ), "Aprovado",IF(AND(G'.$row.'>=5, K'.$row.'>=5, O'.$row.'>=5, S'.$row.'<5, W'.$row.'>=5, AA'.$row.'>=5, AE'.$row.'>=5, AI'.$row.'<5, AM'.$row.'>=5 ), "Aprovado",IF(AND(G'.$row.'>=5, K'.$row.'>=5, O'.$row.'>=5, S'.$row.'<5, W'.$row.'>=5, AA'.$row.'>=5, AE'.$row.'>=5, AI'.$row.'>=5, AM'.$row.'<5 ), "Aprovado",IF(AND(G'.$row.'>=5, K'.$row.'>=5, O'.$row.'>=5, S'.$row.'>=5, W'.$row.'<5, AA'.$row.'<5, AE'.$row.'>=5, AI'.$row.'>=5, AM'.$row.'>=5 ), "Aprovado",IF(AND(G'.$row.'>=5, K'.$row.'>=5, O'.$row.'>=5, S'.$row.'>=5, W'.$row.'<5, AA'.$row.'>=5, AE'.$row.'<5, AI'.$row.'>=5, AM'.$row.'>=5 ), "Aprovado",IF(AND(G'.$row.'>=5, K'.$row.'>=5, O'.$row.'>=5, S'.$row.'>=5, W'.$row.'<5, AA'.$row.'>=5, AE'.$row.'>=5, AI'.$row.'<5, AM'.$row.'>=5 ), "Aprovado",IF(AND(G'.$row.'>=5, K'.$row.'>=5, O'.$row.'>=5, S'.$row.'>=5, W'.$row.'<5, AA'.$row.'>=5, AE'.$row.'>=5, AI'.$row.'>=5, AM'.$row.'<5 ), "Aprovado",IF(AND(G'.$row.'>=5, K'.$row.'>=5, O'.$row.'>=5, S'.$row.'>=5, W'.$row.'>=5, AA'.$row.'<5, AE'.$row.'<5, AI'.$row.'>=5, AM'.$row.'>=5 ), "Aprovado",IF(AND(G'.$row.'>=5, K'.$row.'>=5, O'.$row.'>=5, S'.$row.'>=5, W'.$row.'>=5, AA'.$row.'<5, AE'.$row.'>=5, AI'.$row.'<5, AM'.$row.'>=5 ), "Aprovado",IF(AND(G'.$row.'>=5, K'.$row.'>=5, O'.$row.'>=5, S'.$row.'>=5, W'.$row.'>=5, AA'.$row.'<5, AE'.$row.'>=5, AI'.$row.'>=5, AM'.$row.'<5 ), "Aprovado",IF(AND(G'.$row.'>=5, K'.$row.'>=5, O'.$row.'>=5, S'.$row.'>=5, W'.$row.'>=5, AA'.$row.'>=5, AE'.$row.'<5, AI'.$row.'<5, AM'.$row.'>=5 ), "Aprovado",IF(AND(G'.$row.'>=5, K'.$row.'>=5, O'.$row.'>=5, S'.$row.'>=5, W'.$row.'>=5, AA'.$row.'>=5, AE'.$row.'<5, AI'.$row.'>=5, AM'.$row.'<5 ), "Aprovado",IF(AND(G'.$row.'>=5, K'.$row.'>=5, O'.$row.'>=5, S'.$row.'>=5, W'.$row.'>=5, AA'.$row.'>=5, AE'.$row.'>=5, AI'.$row.'<5, AM'.$row.'<5 ), "Aprovado",IF(AND(G'.$row.'>=5, K'.$row.'>=5, O'.$row.'<5, S'.$row.'>=5, W'.$row.'>=5, AA'.$row.'>=5, AE'.$row.'>=5, AI'.$row.'>=5, AM'.$row.'>=5 ), "Aprovado",IF(AND(G'.$row.'>=5, K'.$row.'>=5, O'.$row.'>=5, S'.$row.'<5, W'.$row.'>=5, AA'.$row.'>=5, AE'.$row.'>=5, AI'.$row.'>=5, AM'.$row.'>=5 ), "Aprovado",IF(AND(G'.$row.'>=5, K'.$row.'>=5, O'.$row.'>=5, S'.$row.'>=5, W'.$row.'<5, AA'.$row.'>=5, AE'.$row.'>=5, AI'.$row.'>=5, AM'.$row.'>=5 ), "Aprovado",IF(AND(G'.$row.'>=5, K'.$row.'>=5, O'.$row.'>=5, S'.$row.'>=5, W'.$row.'>=5, AA'.$row.'<5, AE'.$row.'>=5, AI'.$row.'>=5, AM'.$row.'>=5 ), "Aprovado",IF(AND(G'.$row.'>=5, K'.$row.'>=5, O'.$row.'>=5, S'.$row.'>=5, W'.$row.'>=5, AA'.$row.'>=5, AE'.$row.'<5, AI'.$row.'>=5, AM'.$row.'>=5 ), "Aprovado",IF(AND(G'.$row.'>=5, K'.$row.'>=5, O'.$row.'>=5, S'.$row.'>=5, W'.$row.'>=5, AA'.$row.'>=5, AE'.$row.'>=5, AI'.$row.'<5, AM'.$row.'>=5 ), "Aprovado",IF(AND(G'.$row.'>=5, K'.$row.'>=5, O'.$row.'>=5, S'.$row.'>=5, W'.$row.'>=5, AA'.$row.'>=5, AE'.$row.'>=5, AI'.$row.'>=5, AM'.$row.'<5 ), "Aprovado","Reprovado")))))))))))))))))))))))))))))');
			/*-----------------------------------------------------------------------------------------------------------------------------------*/
			$i++;
			$row++;
		}
