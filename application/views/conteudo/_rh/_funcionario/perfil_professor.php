                    ...
                    <tfoot>
                        <tr>
                            <th class="text-right" colspan="5">
                                <a href="#modal-password" data-toggle="modal" class="btn btn-default m-b-10 p-l-5">
                                    <i class="fa fa-lock text-danger t-plus-1 fa-fw fa-lg"></i>
                ...
                <div class="col-12">
                    <form action="<?= site_url('rh/funcionario/solicitacao_ferias_pdf')?>" method="POST"
                        ...
                        <div class="form-group col-2">
                            <button type="submit" class="btn btn-block btn-outline-primary m-r-5">
