            ...
            <fieldset class="py-3">
                <div class="row">
                    ...
                    <div class="form-group col-4">
                        ...
                        <input type="date" name="nascimento_aluno" class="form-control border-primary"
                            ...
                            value="<?= set_value('nascimento_aluno'); ?>" />
                ...
                <div class="row">
                        ...
                        <div class="btn-group" data-toggle="buttons">
                            <label class="btn btn-outline-primary">
                                <input type="radio" class="custom-control-input cpf-cnpj" id="tipo_documento"
                                    name="tipo_documento" value="B.I" />Bilhete de Identidade
                            </label>
                            <label class="btn btn-outline-primary">
                                <input type="radio" class="custom-control-input cpf-cnpj" id="tipo_documento"
                                    name="tipo_documento" value="Cédula Pessoal" />Cédula Pessoal
                            </label>
                            <label class="btn btn-outline-primary">
                                <input type="radio" class="custom-control-input cpf-cnpj" id="tipo_documento"
                                    name="tipo_documento" value="Passaporte" />Passaporte
                            </label>
                        </div>
                    ...
                    <div class="form-group col-4">
                        ...
                        <input type="text" name="num_documento" class="form-control border-primary" id="InputTipo-doc"
                            placeholder="Selecione o tipo de documento" value="<?= set_value('num_documento'); ?>"
                    ...
                    <div class="form-group col-4">
                        ...
                        <input type="date" name="data_emissao_doc" class="form-control border-primary"
                            id="data_emissao_doc" value="<?= set_value('data_emissao_doc'); ?>" />
                ...
                <div class="row">
                    ...
                    <div class="form-group col-6">
                        ...
                        <input type="text" name="nome_pai" id="nome_pai" class="form-control border-primary"
                            placeholder="Digite o nome do pai" value="<?= set_value('nome_pai'); ?>"
                            autocomplete="off" />
                    </div>
                    <!--------------------------- NOME DO MÃE ------------------------------------->
                    <div class="form-group col-6">
                        ...
                        <input type="text" name="nome_mae" id="nome_mae" class="form-control border-primary"
                            placeholder="Digite o nome da mãe" value="<?= set_value('nome_mae'); ?>"
                            autocomplete="off" />
                    </div>
                </div>
                <!--------------------------- CAMPO ENDERECO ------------------------------------>
                ...
                <div class="row">
                    <div class="form-group col-12">
                        ...
                        <button type="submit" onclick="return validadata_aluno()" id="btn-gurdar-aluno"
