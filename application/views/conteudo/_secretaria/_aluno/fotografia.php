...
<div id="content" class="content">
    ...
    <div class="row">
        ...
        <div class="col-md-6 border">
            <!------------------------------------------------------------------------------------->
            <form action="<?= base_url('secretaria/aluno/recortar'); ?>" method="POST" enctype="multipart/form-data">
        ...
        <!------------------------------------------------------------------------------------------------------------------------>
        <div class="col-md-6 border">
            <form action="<?= base_url('secretaria/aluno/ajaxwebcam')?>" method="POST" enctype="multipart/form-data">
                <div id="form-group">
                    <!-- begin campos ocultos -->
                    <input type="hidden" name="id_aluno" id="id_aluno" value="<?= $aluno['id_aluno']?>" />
