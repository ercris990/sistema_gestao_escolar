<div id="content" class="content">
    ...
    <!-- <div>
        <a href="<?= site_url('reports/export_execel/'.$listagem_alunos->id_ano.'/'.$listagem_alunos->id_turma)?>"
            class="btn btn-danger bts-sm col-2"><i class="fa fa-file-pdf mr-2"></i>EXPORTAR PARA EXECEL</a>
    </div> -->