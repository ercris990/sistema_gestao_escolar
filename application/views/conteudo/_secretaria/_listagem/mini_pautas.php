...
<div id="content" class="content">
    <h4 class="page-header"><i class="fa fa-list mr-5"></i>MINI-PAUTAS</h4>
    <?= $this->session->flashdata('msg'); ?>
    <div class="row alert alert-primary border mt-2">
        <div class="col-12">
            <form action="<?= site_url('secretaria/listagem/listar_mini_pautas')?>" method="POST" class="form-inline"
                id="form_listagem">
                <!-- SELECT ANO LECTIVO -->
