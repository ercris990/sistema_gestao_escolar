<div id="content" class="content">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-center"><?php
                                if ($c_nat->ce == ""){
                                    echo '<span style="color: red;"> - </span>';
                                } elseif (($c_nat->ce >= 0) && ($c_nat->ce < 5)) {
                                    echo '<span style="color: red;">'.number_format($c_nat->ce, 1).'</span>';
                                } elseif (($c_nat->ce >= 5) && ($c_nat->ce <= 10)) {
  ...
  <div class="mt-1">
    <a href="<?= site_url('pautas_xls/pauta_xls_05/export_xls_05/'.$listagem_alunos->id_ano.'/'.$listagem_alunos->id_turma)?>"
