        ...
        <form action="<?php echo site_url('secretaria/turma/salvaractualizacao')?>" method="POST">
            <input type="hidden" name="id_turma" id="id_turma" value="<?= $turma[0]->id_turma; ?>">
                ...
                <div class="form-group col-12">
                    ...
                    <input type="text" name="nome_turma" class="form-control border-primary text-primary"
                        id="nome_turma" minlength="2" placeholder="1A-M" autocomplete="off"
                        value=" <?= $turma[0]->nome_turma; ?>" />
                </div>
                <!-- CAMPO CLASSE -->
                <div class="form-group col-12">
