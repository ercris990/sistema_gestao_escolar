...
<div id="content" class="content">
    <!----------------------------------------------->
    <!-- TITULO CONTEUDO -->
    <h2 class="page-header"><i class="fa fa-briefcase mr-5"></i>PÁGINA INICIAL - COORDENAÇÃO</h2>
    ...
    <div class="row mt-5">
        ...
        <div class="col-lg-3 col-md-6">
            <div class="widget widget-stats bg-blue">
                ...
                <div class="stats-link">
                    <a href="<?= site_url('secretaria/turma/listar_turmas_coordenacao')?>">Ver Detalhes<i
        ...
        <div class="col-lg-3 col-md-6">
            <div class="widget widget-stats bg-blue">
                ...
                <div class="stats-link">
                    <a href="<?= site_url('secretaria/sala/listar_salas_coordenacao')?>">Ver Detalhes<i
                            class="fa fa-arrow-right ml-3"></i></a>
                </div>
            </div>
        </div><!-- end col-3 -->
