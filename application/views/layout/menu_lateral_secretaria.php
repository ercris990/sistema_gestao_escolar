...
<div id="sidebar" class="sidebar">
    ...
    <div data-scrollbar="true" data-height="100%">
        ...
        <ul class="nav text-uppercase mt-3">
            <!-- <li class="nav-header text-light"><strong>PAINEL SECRETARIA</strong></li> -->
            <!--                INICIO MENU E SUB MENU
            ---------------------------------------------------------------------->
            <li class="has-sub">
                <a href="<?= site_url('home/secretaria') ?>">
                    <i class="fa fa-home bg-gradient-dark"></i>
                    <span><b>PÁGINA INICIAL</b></span>
                </a>
            </li><!-- end pagina inicial -->
            <li class="has-sub">
                <a href="<?= site_url('secretaria/aluno/novo_aluno')?>">
                    <i class="fa fa-user-plus bg-gradient-blue"></i>
                    <span><b>NOVO ALUNO</b></span>
                </a>
            </li><!-- fim sub-menu -->
            <!--           INICIO MENU LISTAGEM
            --------------------------------------------------->
            <li class="has-sub">
                <a href="<?= site_url('secretaria/listagem')?>">
                    <i class="fa fa-list bg-gradient-blue"></i>
                    <span><b>LISTA NOMINAL</b></span>
                </a>
            </li>
            <!--                  fim menu e sub-menu
            ---------------------------------------------------------------------->
            <!-- inicio botao minimizar -->
            <li>
                <a href=" javascript:;" class="sidebar-minify-btn" data-click="sidebar-minify">
                    <i class="ion-ios-arrow-left"></i> <span>Minimizar</span>
                </a>
            </li>
            <!-- fim botao minimzar -->
        </ul><!-- fim nav sidebar -->
