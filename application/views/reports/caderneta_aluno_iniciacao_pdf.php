    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <!--    CLASSIFICACAO TRIMESTRAL - CT 1
                    ------------------------------------------------------------------------------- -->
          <td class="al-center">
            <b><?php
                        if ($row->ct_1 == ""){
                            echo '<span style="color: red;"> - </span>';
                        } elseif ( number_format($row->ct_1) == "1" ) {
                            echo '<span style="color: red;"> Ma </span>';
                        } elseif ( number_format($row->ct_1) == "2" ) {
                            echo '<span style="color: red;"> Me </span>';
                        } elseif ( number_format($row->ct_1) == "3" ) {
                            echo '<span style="color: black;"> S </span>';
                        } elseif ( number_format($row->ct_1) == "4" ) {
                            echo '<span style="color: black;"> B </span>';
                        } elseif ( number_format($row->ct_1) == "5" ) {
                            echo '<span style="color: black;"> MB </span>';
                        }
                        ?></b>
          </td>
          <!--    CLASSIFICACAO TRIMESTRAL - CT 2
                    ------------------------------------------------------------------------------- -->
          <td class="al-center">
            <b><?php
                        if ($row->ct_2 == ""){
                            echo '<span style="color: red;"> - </span>';
                        } elseif ( number_format($row->ct_2) == "1" ) {
                            echo '<span style="color: red;"> Ma </span>';
                        } elseif ( number_format($row->ct_2) == "2" ) {
                            echo '<span style="color: red;"> Me </span>';
                        } elseif ( number_format($row->ct_2) == "3" ) {
                            echo '<span style="color: black;"> S </span>';
                        } elseif ( number_format($row->ct_2) == "4" ) {
                            echo '<span style="color: black;"> B </span>';
                        } elseif ( number_format($row->ct_2) == "5" ) {
                            echo '<span style="color: black;"> MB </span>';
                        }
                        ?></b>
          </td>
          <!--    CLASSIFICACAO TRIMESTRAL - CT 3
                    ------------------------------------------------------------------------------- -->
          <td class="al-center">
            <b><?php
                        if ($row->ct_3 == ""){
                            echo '<span style="color: red;"> - </span>';
                        } elseif ( number_format($row->ct_3) == "1" ) {
                            echo '<span style="color: red;"> Ma </span>';
                        } elseif ( number_format($row->ct_3) == "2" ) {
                            echo '<span style="color: red;"> Me </span>';
                        } elseif ( number_format($row->ct_3) == "3" ) {
                            echo '<span style="color: black;"> S </span>';
                        } elseif ( number_format($row->ct_3) == "4" ) {
                            echo '<span style="color: black;"> B </span>';
                        } elseif ( number_format($row->ct_3) == "5" ) {
                            echo '<span style="color: black;"> MB </span>';
                        }
                        ?></b>
          </td>
