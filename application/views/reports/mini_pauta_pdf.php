      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="al-center"><?php
                        if ($aluno->ce == ""){
                            echo '<span style="color: red;"> -- </span>';
                        } elseif ((number_format($aluno->ce) >= 0) && (number_format($aluno->ce) < 5)) {
                            echo '<span style="color: red;">'.number_format($aluno->ce).'</span>';
                        } elseif ((number_format($aluno->ce) >= 5) && (number_format($aluno->ce) <= 10)) {
                            echo '<span style="color: black;">'.number_format($aluno->ce).'</span>';
                        }
                    ?></td>
          <!--                CF
                    ----------------------------------------------------------- -->
